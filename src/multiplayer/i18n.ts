...
const es = {
  ...
  inviteCopied: '¡Enlace copiado!', inviteFailed: 'No se pudo compartir el enlace.', invitationReady: 'Invitación lista para la sala {code}.',
  invitationHeading: '¡Te han retado a una partida!', invitationRules: 'Reglas de la partida',
  invitationLoading: 'Preparando la invitación…', invitationUnavailable: 'Esta invitación ya no está disponible',
  invitationInvalid: 'El enlace de invitación no es válido.', invitationLoadFailed: 'No se pudo cargar la partida.',
  retryInvitation: 'Volver a intentarlo',
  joinInvitation: 'Unirse a la partida', preferDifferentRules: '¿Prefieres otras reglas?',
  createYourGame: 'Crea tu partida', goToMultiplayer: 'Ir a Multijugador',
...
const ca: typeof es = {
  ...
  inviteCopied: 'Enllaç copiat!', inviteFailed: "No s'ha pogut compartir l'enllaç.", invitationReady: 'Invitació preparada per a la sala {code}.',
  invitationHeading: "T'han reptat a una partida!", invitationRules: 'Regles de la partida',
  invitationLoading: 'Preparant la invitació…', invitationUnavailable: 'Aquesta invitació ja no està disponible',
  invitationInvalid: "L'enllaç d'invitació no és vàlid.", invitationLoadFailed: "No s'ha pogut carregar la partida.",
  retryInvitation: 'Torna-ho a provar',
  joinInvitation: 'Uneix-te a la partida', preferDifferentRules: 'Prefereixes altres regles?',
  createYourGame: 'Crea la teva partida', goToMultiplayer: 'Ves a Multijugador',
...
export function errorMessage(code: string, t: MultiplayerTranslations) {
  const messages: Record<string, string> = {
    ...
    'invalid-invitation': t.invitationInvalid, 'preview-load-failed': t.invitationLoadFailed,
