...
export function LobbyPage({ state, interfaceLanguage, messages, playerId, typingPlayer, onLeave }: { state: PlayerGameView; interfaceLanguage: 'ca' | 'es'; messages: ChatMessage[]; playerId: string; typingPlayer: { playerId: string; playerName: string } | null; onLeave: () => void }) {
